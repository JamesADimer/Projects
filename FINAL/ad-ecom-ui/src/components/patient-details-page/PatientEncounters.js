              ...
              <div key={encounter.id} data-testid="encounter">
                <Accordion>
                  ...
                  <AccordionDetails>
                    ...
                    <br />
                    <Typography className={styles.encountersDetail}>
                      {`Billing Code: ${encounter.billing_code}`}
                    </Typography>
                    <br />
                    <Typography className={styles.encountersDetail}>
                    ...
                    <br />
                    <Typography className={styles.encountersDetail}>
                      {`Total Cost: $${Number(encounter.total_cost).toFixed(2)}`}
                    </Typography>
                    <br />
                    <hr />
                    <br />
                    <button
                      ...
                      onClick={() => {
                        history.push({
                          pathname: `/patients/${encounter.patient_id}/encounters/${encounter.id}/edit`
                        });
                      }}
                    >
                      Edit Encounter
